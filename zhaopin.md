...
## 服务器硬件工程师
职位描述[参考国鑫](http://www.gooxi.com/content/714.html)：
- 负责服务器硬件的维护，故障排查
- 负责服务器硬件产品测试的设计和分析，制定测试方案；
- 搭建测试环境，承担产品的功能、性能、等测试，发现硬件故障等问题，跟踪解决相关问题；
- 熟练使用示波器等工具进行单板硬件的调试、测试；

任职要求：
- 本科以上学历，电子相关专业，3年以上工作经验；
- 有较强的模拟、数字电路基础，熟悉常用的电子器件；
- 具备单板硬件基础，能根据原理图和PCB图进行问题定位和验证；
- 熟悉常用的测试仪器的使用，包括示波器、万用表等；
- 熟悉X86架构测试者优先。
